...
<head>
    ...
    <style>
        ...
        /* ... Giữ nguyên CSS layout chung của bạn ... */
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="active"><a href="manageProduct"><i class="fas fa-palette"></i> Xưởng chế tác</a></li>
    ...
    <main class="main-content">
        ...
        <section class="panel">
            <div class="success-container">
                ...
                <h2 class="success-title">Thêm Tác Phẩm Thành Công!</h2>
                <p class="success-message">
                    Tác phẩm "<strong>${addedProductName}</strong>" của bạn đã được thêm vào xưởng chế tác và sẵn sàng để mọi người chiêm ngưỡng.
                </p>
                <div class="success-actions">
                    <a href="createProduct" class="action-button secondary">
                        <i class="fas fa-plus"></i>
                        Tiếp tục thêm tác phẩm
                    </a>
                    <a href="seller" class="action-button">
