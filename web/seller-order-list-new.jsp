                        ...
                        <c:forEach var="subOrder" items="${subOrders}">
                            <div class="order-card">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="customer-info">
                                            ...
                                            <p class="mb-1"><strong>Tên:</strong> ${subOrder.shippingName}</p>
                                            <p class="mb-1"><strong>SĐT:</strong> ${subOrder.shippingPhone}</p>
                                            <p class="mb-0"><strong>Địa chỉ:</strong> ${subOrder.shippingAddress}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="customer-info">
                                            ...
                                            <p class="mb-0"><strong>Thanh toán:</strong> ${subOrder.paymentMethod}</p>
                                            <c:if test="${not empty subOrder.cancelReason}">
                                                <p class="mb-0"><strong>Lý do hủy/thất bại:</strong> 
                                                    <span class="text-danger">${subOrder.cancelReason}</span>
                                                </p>
                                            </c:if>
                                        </div>
                                    </div>
                                ...
                                <div class="action-buttons">
                                    <a href="seller-order-detail?subOrderId=${subOrder.subOrderId}" 
