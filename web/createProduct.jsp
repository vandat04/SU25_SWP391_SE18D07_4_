...
<body>
    ...
    <aside class="sidebar">
        ...
        <c:if test="${not empty sessionScope.acc}">
            <div class="sidebar-profile">
                <img src="${not empty sessionScope.acc.avatarUrl ? sessionScope.acc.avatarUrl : 'https://i.pravatar.cc/150?u='}${sessionScope.acc.userID}" alt="Artisan avatar" class="avatar">
    ...
    <main class="main-content">
        <header class="main-header">
            ...
            <p>Fill in the details to introduce your product to everyone.</p>
        </header>
            ...
            <form action="createProduct" method="post">
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input id="name" type="text" name="name" class="form-control" required placeholder="Ex: Blue Glazed Ceramic Vase" value="${param.name}">
                    </div>

                    <div class="form-group">
                        <label for="sku">SKU</label>
                        <input id="sku" type="text" name="sku" class="form-control" placeholder="Ex: BG-BLUGLAZE-01" value="${param.sku}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="price" type="number" step="1000" name="price" class="form-control" required placeholder="Ex: 500000" value="${param.price}">
                    </div>

                    <div class="form-group">
                        <label for="stock">Stock Quantity</label>
                        <input id="stock" type="number" name="stock" class="form-control" required placeholder="Ex: 10" value="${param.stock}">
                    </div>
                    
                    <div class="form-group">
                        <label for="weight">Weight (grams)</label>
                        <input id="weight" type="number" step="1" name="weight" class="form-control" placeholder="Ex: 1500" value="${param.weight}">
                    </div>

                    <div class="form-group">
                        <label for="dimensions">Dimensions (L x W x H)</label>
                        <input id="dimensions" type="text" name="dimensions" class="form-control" placeholder="Ex: 25cm x 15cm x 10cm" value="${param.dimensions}">
                    </div>
                    
                    <div class="form-group full-width">
                        <label for="description">Detailed Description</label>
                        <textarea id="description" name="description" class="form-control" rows="6" placeholder="Tell a story about your product...">${param.description}</textarea>
                    </div>

                    <div class="form-group full-width">
                        <label for="materials">Materials</label>
                        <input id="materials" type="text" name="materials" class="form-control" placeholder="Ex: Bat Trang ceramic, natural blue glaze" value="${param.materials}">
                    </div>

                    <div class="form-group full-width">
                        <label for="careInstructions">Care Instructions</label>
                        <textarea id="careInstructions" name="careInstructions" class="form-control" rows="4" placeholder="Ex: Wipe with a soft cloth, avoid strong impacts...">${param.careInstructions}</textarea>
                    </div>
                    
                    <div class="form-group">
                        <label for="warranty">Warranty Information</label>
                        <input id="warranty" type="text" name="warranty" class="form-control" placeholder="Ex: 6 months for glaze color" value="${param.warranty}">
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-check" style="padding-top: 1.5rem;">
                            ...
                            <label for="status">Display this product for sale</label>    
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-check" style="padding-top: 1.5rem;">
                            ...
                            <label for="isFeatured">Set as featured product</label>
                        </div>
                    </div>
