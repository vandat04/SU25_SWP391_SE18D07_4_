...
<html class="no-js" lang="en">
    <head>
        ...
        <title>List of Delivering List - Da Nang Craft Village</title>
    ...
    <body class="biolife-body">
        ...
        <jsp:include page="Menu.jsp"></jsp:include>
            ...
            <div class="hero-section hero-background">
                <h1 class="page-title">List of Delivering List</h1>
            </div>
            <!-- Page Contain -->
                    ...
                    <div class="container">
                        <nav class="biolife-nav">
                            <ul>
                                ...
                                <li class="nav-item"><span class="#">Delivering List</span></li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <tbody>
                            <c:forEach var="od" items="${deliveryOrderDetail}">
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${od.status == 1}">Delivering</c:when>
                        ...
                        <tbody>
                            <c:forEach var="tod" items="${deliveryTicketOrderDetail}">
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${tod.status == 1}">Delivering</c:when>
                                            <c:otherwise>Unknown</c:otherwise>
                                        </c:choose>
                                    </td>
