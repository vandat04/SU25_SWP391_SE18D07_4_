...
/**
 * Comprehensive ticket service implementation Combines village ticket,
 * availability, and cart operations with business logic
 */
public class TicketService implements ITicketService {
    ...
    private void rollbackReservations(List<CartTicket> cartTickets, CartTicket failedTicket) {
        for (CartTicket cartTicket : cartTickets) {
            if (cartTicket.equals(failedTicket)) {
                break;
            }
    ...
    public List<Ticket> searchTicketByAdmin(int status, int searchID, String searchContent) {
        return tDAO.searchTicketByAdmin(status, searchID, searchContent);
    }
    ...
    public List<Ticket> searchTicketByAdmin(int status, int searchID, String searchContent, int offset, int pageSize) {
        return tDAO.searchTicketByAdmin(status, searchID, searchContent, offset, pageSize);
    }

    public int countTotalTicketByAdmin(int status, int searchID, String searchContent) {
        return tDAO.countTotalTicketByAdmin(status, searchID, searchContent);
    }
}
