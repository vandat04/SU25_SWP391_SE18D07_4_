...
public int getTotalSubOrders(int status, int searchID, String contentSearch) {
    ...
    // New methods for seller order management
    public List<SubOrder> getSubOrdersByVillageId(int villageId, int status, String searchKeyword, int page, int pageSize) {
        List<SubOrder> orders = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try {
            ...
            sql.append("SELECT so.*, o.shippingAddress, o.shippingPhone, o.shippingName, ")
               .append("a.userName, a.fullName ")
               .append("FROM SubOrder so ")
               .append("JOIN Orders o ON so.orderId = o.id ")
               .append("JOIN Account a ON o.userID = a.userID ")
               .append("WHERE so.villageId = ? ");
            
            if (status >= 0) {
                sql.append("AND so.orderStatus = ? ");
            }
            
            if (searchKeyword != null && !searchKeyword.trim().isEmpty()) {
                sql.append("AND (o.shippingName LIKE ? OR o.shippingPhone LIKE ? OR so.subOrderId LIKE ?) ");
            }
            
            sql.append("ORDER BY so.createdDate DESC ")
            ...
            while (rs.next()) {
                SubOrder subOrder = mapResultSetToSubOrder(rs);
                orders.add(subOrder);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public int getTotalSubOrdersByVillageId(int villageId, int status, String searchKeyword) {
        int total = 0;
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public boolean updateSubOrderStatus(int subOrderId, int newStatus) {
        Connection conn = null;
        PreparedStatement ps = null;
        
        try {
            conn = DBContext.getConnection();
            String sql = "UPDATE SubOrder SET orderStatus = ?, updatedDate = GETDATE() WHERE subOrderId = ?";
            ps = conn.prepareStatement(sql);
    ...
    public boolean updateSubOrderStatusWithReason(int subOrderId, int newStatus, String reason) {
        Connection conn = null;
        PreparedStatement ps = null;
        
        try {
            conn = DBContext.getConnection();
            String sql = "UPDATE SubOrder SET orderStatus = ?, cancelReason = ?, cancelDate = GETDATE(), updatedDate = GETDATE() WHERE subOrderId = ?";
            ps = conn.prepareStatement(sql);
            ps.setInt(1, newStatus);
            ps.setString(2, reason);
            ps.setInt(3, subOrderId);
    ...
    public entity.Account.Account getCustomerByOrderId(int orderId) {
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public List<OrderDetail> getOrderDetailsByVillageId(int villageId, int status, String searchKeyword, int page, int pageSize) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                orderDetail.setVillageID(rs.getInt("villageID"));
                orderDetail.setPaymentMethod(rs.getString("paymentMethod"));
                orderDetail.setPaymentStatus(rs.getInt("paymentStatus"));
                orderDetail.setCancelReason(rs.getString("cancelReason"));
                orderDetail.setCancelDate(rs.getTimestamp("cancelDate"));
                orderDetail.setRefundAmount(rs.getBigDecimal("refundAmount"));
                orderDetail.setRefundDate(rs.getTimestamp("refundDate"));
                orderDetail.setRefundReason(rs.getString("refundReason"));
                orderDetail.setCreatedDate(rs.getTimestamp("createdDate"));
                orderDetail.setUpdatedDate(rs.getTimestamp("updatedDate"));
                orderDetail.setPoints(rs.getInt("points"));
                
                // Additional fields from joins
                orderDetail.setShippingAddress(rs.getString("shippingAddress"));
                orderDetail.setShippingPhone(rs.getString("shippingPhone"));
                orderDetail.setShippingName(rs.getString("shippingName"));
                ...
                orderDetail.setProductImage(rs.getString("pimage"));
                orderDetail.setOrderCreatedDate(rs.getTimestamp("orderCreatedDate"));
    ...
    public boolean updateOrderDetailStatus(int orderDetailId, int newStatus) {
        Connection conn = null;
        PreparedStatement ps = null;
        ...
        try {
            conn = DBContext.getConnection();
            String sql = "UPDATE OrderDetail SET status = ?, updatedDate = GETDATE() WHERE id = ?";
            ps = conn.prepareStatement(sql);
            ps.setInt(1, newStatus);
    ...
    public boolean updateOrderDetailStatusWithReason(int orderDetailId, int newStatus, String reason) {
        Connection conn = null;
        PreparedStatement ps = null;
        boolean success = false;
        ...
        try {
            conn = DBContext.getConnection();
            String sql = "UPDATE OrderDetail SET status = ?, cancelReason = ?, cancelDate = GETDATE(), updatedDate = GETDATE() WHERE id = ?";
            ps = conn.prepareStatement(sql);
            ps.setInt(1, newStatus);
            ps.setString(2, reason);
