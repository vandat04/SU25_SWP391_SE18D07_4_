...
public class ReviewDAO {
    ...
    private Review mapResultSetToReview(ResultSet rs) throws SQLException {
        ...
        review.setUpdatedDate(rs.getTimestamp("updatedDate"));
        return review;
    }

    // Compatibility methods for destination project structure
    public List<entity.Product.ProductReview> getReviewsByProductId(int productId) { return new ArrayList<>(); }
    public double getAverageRating(int productId) { return getProductAverageRating(productId); }
    public int getReviewCount(int productId) { return getReviewsByProduct(productId).size(); }
