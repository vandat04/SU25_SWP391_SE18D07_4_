...
public class SubOrder {
    ...
    // Additional properties for seller management
    private List<OrderDetail> orderDetails;
    private List<TicketOrderDetail> ticketDetails;
    ...
    public List<TicketOrderDetail> getTicketDetails() {
        return ticketDetails;
    }

    public void setTicketDetails(List<TicketOrderDetail> ticketDetails) {
